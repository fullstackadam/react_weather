...
/***/ function(module, exports, __webpack_require__) {
	...
	var Weather = React.createClass({
		...
		handleNewLocation: function handleNewLocation(city) {
			var that = this;
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					'div',
					null,
					React.createElement('input', { type: 'text', ref: 'location', placeholder: 'Enter a city name' })
				),
				React.createElement(
					'div',
					null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OPEN_WEATHER_MAP_API_KEY = '75acb723f4b873629cd14a59cf81e04f';

	var OPEN_WEATHER_MAP_URL = 'http://api.openweathermap.org/data/2.5/weather?appid=' + OPEN_WEATHER_MAP_API_KEY + '&units=imperial';
